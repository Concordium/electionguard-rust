...
//! * [`primitive_unsigned`](crate::primitive_unsigned) Trait for describing `u8`, `u16`, `u32`, `u64`, and `u128`, specifically.
//! * [`with_t_upt`](crate::with_t_upt) Macros for working with generic types `T` when `T` is `PrimitiveUnsigned`.
//! * [``](crate::)
